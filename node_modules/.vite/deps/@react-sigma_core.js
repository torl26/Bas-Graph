...
function loadProgram(gl, shaders) {
  ...
  var i2, l2;
  for (i2 = 0, l2 = shaders.length; i2 < l2; i2++)
    ...
    if (this.isInstanced) {
      ...
      for (var i2 = 0; i2 < this.CONSTANT_DATA.length; i2++) {
        ...
        for (var j2 = 0; j2 < vector.length; j2++)
          this.constantArray[i2 * constantAttributesItemsCount + j2] = vector[j2];
      }
  ...
  return _createClass(Camera2, [{
    ...
    value: function getBoundedRatio(ratio) {
      ...
      if (typeof this.minRatio === "number")
        r2 = Math.max(r2, this.minRatio);
      if (typeof this.maxRatio === "number")
        r2 = Math.min(r2, this.maxRatio);
      return r2;
    }
    /**
...
function getTouchesArray(touches) {
  var arr = [];
  for (var i2 = 0, l2 = Math.min(touches.length, MAX_TOUCHES); i2 < l2; i2++)
    arr.push(touches[i2]);
  return arr;
}
...
function getWheelDelta(e2) {
  if (typeof e2.deltaY !== "undefined")
    return e2.deltaY * -3 / 360;
  if (typeof e2.detail !== "undefined")
    return e2.detail / -9;
